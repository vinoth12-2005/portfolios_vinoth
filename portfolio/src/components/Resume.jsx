              ...
              <div className="flex flex-col sm:flex-row items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <a href={profile.resumeUrl} download className="cyber-btn cyber-btn-primary flex items-center gap-2" id="resume-download"><FiDownload /> Download Resume</a>
                    <a href={profile.resumeUrl} target="_blank" rel="noopener noreferrer" className="cyber-btn flex items-center gap-2" id="resume-preview"><FiEye /> Open Resume</a>
                  </div>
                </div>
              </div>
